...
require('packer').startup(function(use)
  ...
  -- My changes to original template
  use {'neoclide/coc.nvim', branch = 'release'}

  use 'godlygeek/tabular' -- Align text in visual mode
...
vim.o.hlsearch = true
vim.api.nvim_set_keymap("n", "<C-c>", ":noh<CR>", {noremap = true})
    ...
    lualine_c = {
      {
        ...
        buffers_color = {
          -- Same values as the general color option can be used here.
           active = { fg = c.orange, bg = c.bg0, gui='bold' },     -- Color for active buffer.
          -- inactive = 'blue', -- Color for inactive buffer.
        },
...
vim.keymap.set({ 'n', 'v' }, 'l', 'gk', { silent = true })
vim.keymap.set({ 'n', 'v' }, 'k', 'gj', { silent = true })
vim.keymap.set({ 'n', 'v' }, 'j', 'h', { silent = true })

vim.api.nvim_set_keymap("v", "<F9>", '"*y :let @+=@*<CR>', {noremap=true, silent=true})
vim.api.nvim_set_keymap("n", "<F10>", '"+p', {noremap=true, silent=true})

-- Do not jump immediatelly to next result when searching
vim.api.nvim_set_keymap("n", "*", "g*``", {})
vim.api.nvim_set_keymap("n", "#", "g#``", {})
-- Search on Ctrl+F, cancel search on Ctrl+C
vim.api.nvim_set_keymap("n", "<C-f>", "*", {})
vim.api.nvim_set_keymap("n", "<C-c>", ":nohlsearch<CR>", {})
-- Center line while searching 
vim.api.nvim_set_keymap("n", "n", "nzz", {})
vim.api.nvim_set_keymap("n", "N", "Nzz", {})
-- Jump to end of line on Ctrl+E
vim.api.nvim_set_keymap("n", "<C-e>", "$", {})
-- When indenting in visual mode, don't quit the visual mode
vim.api.nvim_set_keymap("v", "<", "<gv", {})
vim.api.nvim_set_keymap("v", ">", ">gv", {})
-- Change buffers on Ctrl+n and Ctrl+p
